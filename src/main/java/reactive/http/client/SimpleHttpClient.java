...
import reactive.json.response.ErrorResponse;
import reactive.http.ReaderStrategy;
import reactive.http.WriterStrategy;
...
public class SimpleHttpClient {
    ...
    /**
     * Obtain a {@link reactive.http.client.SimpleHttpClient} builder.
     *
     * @return a builder
     */
     ...
     * {@link reactive.http.client.ExchangeFilter},
                ...
                .flatMap(response -> {
                    ...
                    if (responseStatus >= 400 && responseStatus < 600) {
                        return readerStrategy.map(SimpleHttpClient::<ErrorResponse>cast)
                                .filter(s -> s.canRead(ErrorResponse.class, contentType))
    ...
    /**
     * A mutable builder for a {@link reactive.http.client.SimpleHttpClient}.
     */
    public interface Builder {
        ...
        /**
         * Configure the {@link reactive.http.WriterStrategy} to use. It will be added to the list of strategies.
         *
        ...
        /**
         * Configure the {@link reactive.http.ReaderStrategy} to use. It will be added to the list of strategies.
         *
        ...
        /**
         * Build the {@link reactive.http.client.SimpleHttpClient} instance.
         *
         * @return a client
         */
